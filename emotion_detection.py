...
parser.add_argument("-i", "--video", type=str,default='video/novak_djokovic.mp4',
                    help="path to the video file/ webcam")
parser.add_argument("-m", "--model", type=str, default='output/model.pth',
                    help="path to the trained model")
parser.add_argument('-p', '--prototxt', type=str, default='model/deploy.prototxt.txt',
                    help='Path to deployed prototxt.txt model architecture file')
parser.add_argument('-c', '--caffemodel', type=str, default='model/res10_300x300_ssd_iter_140000_fp16.caffemodel',
